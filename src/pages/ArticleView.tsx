            ...
            <div className="mb-8 border-b-4 border-[#111111] pb-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-4 border-y border-gray-200 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-3 mt-4 sm:mt-0">
                  ...
                  <button onClick={handleCopyLink} className="lg:hidden w-9 h-9 rounded-full flex items-center justify-center border border-gray-200 text-gray-600 hover:text-[#00a85a] hover:border-[#00a85a] transition"><LinkIcon size={16} /></button>
                </div>
              </div>
          </div>
